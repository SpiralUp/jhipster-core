...
// security
createToken({ name: 'SECURE', pattern: 'secure' });
createToken({ name: 'ROLES', pattern: 'roles' });
createToken({ name: 'CUSTOM_SECURITY', pattern: 'privilegesSecurity' });
createToken({ name: 'ALLOWS', pattern: 'allows' });
createToken({ name: 'REQUIRE_PRIVS', pattern: 'requirePrivs' });
createToken({ name: 'PRIVILEGES', pattern: 'privileges' });
createToken({ name: 'PARENT_PRIVILEGES', pattern: 'parentPrivileges' });
createToken({ name: 'REL_PRIVILEGES', pattern: 'relPrivileges' });
createToken({ name: 'PARENT', pattern: 'parent' });
createToken({ name: 'FROM_ENTITY', pattern: 'fromEntity' });
createToken({ name: 'TO_ENTITY', pattern: 'toEntity' });
createToken({ name: 'FIELD', pattern: 'field' });
