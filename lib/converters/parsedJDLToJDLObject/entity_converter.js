 ...
 * @param jdlSecureGetterFunction - the function called to retrieve SECURE related fields for an entity.
 * @returns {Array<JDLEntity>} converted JDLEntity objects.
 */
function convertEntities(parsedEntities, jdlFieldGetterFunction, jdlSecureGetterFunction) {
  if (!parsedEntities) {
